    ...
    for(ULong64_t entry = 0; entry < nEntries; ++entry){
        ...
        for(unsigned int pI = 0; pI < photon_pt_p->size(); ++pI){
            ...
            if(ptPos >= 0){
                ...
                if(isMC && ( (doBackgroundPhotons && truthPhotonPt<=0) || (!doBackgroundPhotons && truthPhotonPt > 0 && (getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2)))){  
