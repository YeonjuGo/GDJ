...
int gdjDataMCPlotter_dijet(std::string inConfigFileName)
{
  checkMakeDir check;
...
{
  if(argc != 2){
    std::cout << "Usage: ./bin/gdjDataMCPlotter_dijet.exe <inConfigFileName>" << std::endl;
  ...
  int retVal = 0;
  retVal += gdjDataMCPlotter_dijet(argv[1]);
  return retVal;
}
