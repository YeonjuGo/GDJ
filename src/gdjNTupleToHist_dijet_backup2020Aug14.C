...
int gdjNTupleToHist_dijet(std::string inConfigFileName)
{
 ...
 //Pt sub bins handling
  ...
  for(ULong64_t entry = 0; entry < nEntries; ++entry){
    ...
    //std::cout << "yj comment: start the photon loop" << std::endl;
    for(unsigned int pI = 0; pI < photon_pt_p->size(); ++pI){
    //std::cout << "yj comment: aa" << std::endl;
      if(!photon_tight_p->at(pI)) continue;
    //std::cout << "yj comment: ba" << std::endl;
      if(photon_pt_p->at(pI) < gammaPtBins[0]) continue;
    //std::cout << "yj comment: ca" << std::endl;
      if(photon_pt_p->at(pI) >= gammaPtBins[nGammaPtBins]) continue;
    //std::cout << "yj comment: da" << std::endl;
    ...
    //std::cout << "yj comment: a" << std::endl;
