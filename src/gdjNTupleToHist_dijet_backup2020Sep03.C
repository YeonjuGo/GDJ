...
int gdjNTupleToHist_dijet(std::string inConfigFileName)
{
 ...
 //Pt sub bins handling
  ...
  //for dijets
  TH1F* photonDiJtDPhiJet1Jet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtDPhiPhotonJetsVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtDPhiPhotonJet1VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtDPhiPhotonJet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtPtVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtEtaVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtMassJet1Jet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtMassPhotonJet1Jet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtSumPtVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtSumPtXjgVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH2F* photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH2F* photonDPhiJets_PhotonLeadingJetVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonDiJtSumPtXjg_includingN1_VCentPt_p[nMaxCentBins][nMaxSubBins+1]; // 4 momentum sum of dijets in a given event + single jet event
  //TH1F* photonDiJtSumPtXjg_allJets_VCentPt_p[nMaxCentBins][nMaxSubBins+1]; //4 momentum sum of all jets in a given event

  //for dijets MC!!
  TH1F* photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtPtVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtEtaVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtMassJet1Jet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtSumPtVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtSumPtXjgVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH2F* photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH2F* photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH1F* photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[nMaxCentBins][nMaxSubBins+1]; // 4 momentum sum of dijets in a given event + single jet event
  TH2F* photonOnlyGenDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  TH2F* photonOnlyGenDPhiJets_PhotonLeadingJetVCentPt_p[nMaxCentBins][nMaxSubBins+1];
  //TH1F* photonGenMatchedDiJtSumPtXjg_allJets_VCentPt_p[nMaxCentBins][nMaxSubBins+1]; //4 momentum sum of all jets in a given event
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    for(Int_t eI = 0; eI < nEtaBinsSub+1; ++eI){
      photonPtVCentEta_p[cI][eI] = new TH1F(("photonPtVCentEta_" + centBinsStr[cI] + "_" + etaBinsSubStr[eI]+ "_h").c_str(), ";p_{T}^{#gamma} [GeV];Counts", nGammaPtBins, gammaPtBins);
    ...
    for(Int_t pI = 0; pI < nGammaPtBinsSub+1; ++pI){
      ...
      photonEtaVCentPt_p[cI][pI] = new TH1F(("photonEtaVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_h").c_str(), ";#eta^{#gamma};Counts", nEtaBins, etaBins);
      photonPhiVCentPt_p[cI][pI] = new TH1F(("photonPhiVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_h").c_str(), ";#phi^{#gamma};Counts", nPhiBins, phiBins);
      ...
      //dijets
      photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI] = new TH1F(("photonDiJtDPhiJet1Jet2VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{jet,jet};#frac{1}{N_{#gamma}} #frac{dN_{jet,jet}}{d#Delta#phi^{jet,jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
      photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI] = new TH1F(("photonDiJtDPhiPhotonJetsVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,jet};#frac{1}{N_{#gamma}} #frac{dN_{#gamma,jet}}{d#Delta#phi^{#gamma,jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
      photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI] = new TH1F(("photonDiJtDPhiPhotonJet1VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#frac{1}{N_{#gamma}} #frac{dN_{#gamma,leading-jet}}{d#Delta#phi^{#gamma,leading-jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
      photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI] = new TH1F(("photonDiJtDPhiPhotonJet2VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,subleading jet};#frac{1}{N_{#gamma}} #frac{dN_{#gamma,subleading-jet}}{d#Delta#phi^{#gamma,subleading-jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
      photonDiJtPtVCentPt_p[cI][pI] = new TH1F(("photonDiJtPtVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";p_{T}^{jet} [GeV/c];#frac{1}{N_{#gamma}} #frac{dN_{jet}}{dp_{T}^{jet}}", nJtPtBins, jtPtBins);
      photonDiJtEtaVCentPt_p[cI][pI] = new TH1F(("photonDiJtEtaVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";#eta^{jet};#frac{1}{N_{#gamma}} #frac{dN_{jet}}{d#eta^{jet}}", nEtaBins, etaBins);
      photonDiJtMassJet1Jet2VCentPt_p[cI][pI] = new TH1F(("photonDiJtMassJet1Jet2VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";m^{jet,jet} [GeV/c^{2}];#frac{1}{N_{#gamma}} #frac{dN_{jet,jet}}{dm^{jet,jet}}", nMassBins, massBins);
      photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI] = new TH1F(("photonDiJtMassPhotonJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";m^{#gamma,jet,jet} [GeV/c^{2}];#frac{1}{N_{#gamma}} #frac{dN_{#gamma,jet,jet}}{dm^{#gamma,jet,jet}}", nMassBins, massBins);
      photonDiJtSumPtVCentPt_p[cI][pI] = new TH1F(("photonDiJtSumPtVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";p_{T}^{leading jet + subleading jet} [GeV/c];#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nJtPtBins, jtPtBins);
      photonDiJtSumPtXjgVCentPt_p[cI][pI] = new TH1F(("photonDiJtSumPtXjgVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";x_{J,#gamma} (leading jet + subleading jet);#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nXJBins, xjBins);
      photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI] = new TH1F(("photonDiJtSumPtXjg_includingN1_VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";x_{J,#gamma} (J;leading jet when N_{Jet}=1 or leading jet + subleading jet);#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nXJBins, xjBins);
      //photonDiJtSumPtXjg_allJets_VCentPt_p[cI][pI] = new TH1F(("photonDiJtSumPtXjg_allJets_VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";x_{J,#gamma} (J;4 momentum sum of all jets);#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nXJBins, xjBins);


      //dijets TH2F
      photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI] = new TH2F(("photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#Delta#phi_{#gamma,subleading jet}", nDPhiBins, 0, TMath::Pi() + 0.01, nDPhiBins, 0, TMath::Pi() + 0.01);
      photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI] = new TH2F(("photonDPhiJets_PhotonLeadingJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#Delta#phi_{leading jet,subleading jet}", nDPhiBins, 0, TMath::Pi() + 0.01, nDPhiBins, 0, TMath::Pi() + 0.01);

      centerTitles({photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonDiJtPtVCentPt_p[cI][pI], photonDiJtEtaVCentPt_p[cI][pI], photonDiJtMassJet1Jet2VCentPt_p[cI][pI], photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonDiJtSumPtVCentPt_p[cI][pI], photonDiJtSumPtXjgVCentPt_p[cI][pI], photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]});
      setSumW2({photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonDiJtPtVCentPt_p[cI][pI], photonDiJtEtaVCentPt_p[cI][pI], photonDiJtMassJet1Jet2VCentPt_p[cI][pI], photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonDiJtSumPtVCentPt_p[cI][pI], photonDiJtSumPtXjgVCentPt_p[cI][pI], photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]});

     // centerTitles({photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonDiJtPtVCentPt_p[cI][pI], photonDiJtEtaVCentPt_p[cI][pI], photonDiJtMassJet1Jet2VCentPt_p[cI][pI], photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonDiJtSumPtVCentPt_p[cI][pI], photonDiJtSumPtXjgVCentPt_p[cI][pI], photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI],photonDiJtSumPtXjg_allJets_VCentPt_p[cI][pI]});
     // setSumW2({photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonDiJtPtVCentPt_p[cI][pI], photonDiJtEtaVCentPt_p[cI][pI], photonDiJtMassJet1Jet2VCentPt_p[cI][pI], photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonDiJtSumPtVCentPt_p[cI][pI], photonDiJtSumPtXjgVCentPt_p[cI][pI], photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI],photonDiJtSumPtXjg_allJets_VCentPt_p[cI][pI]});
       
      if(isMC){ 
          //dijets
          photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtDPhiJet1Jet2VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{jet,jet};#frac{1}{N_{#gamma}} #frac{dN_{jet,jet}}{d#Delta#phi^{jet,jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
          photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtDPhiPhotonJetsVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,jet};#frac{1}{N_{#gamma}} #frac{dN_{#gamma,jet}}{d#Delta#phi^{#gamma,jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
          photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtDPhiPhotonJet1VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#frac{1}{N_{#gamma}} #frac{dN_{#gamma,leading-jet}}{d#Delta#phi^{#gamma,leading-jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
          photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtDPhiPhotonJet2VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,subleading jet};#frac{1}{N_{#gamma}} #frac{dN_{#gamma,subleading-jet}}{d#Delta#phi^{#gamma,subleading-jet}}", nDPhiBins, 0, TMath::Pi() + 0.01);
          photonGenMatchedDiJtPtVCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtPtVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";p_{T}^{jet} [GeV/c];#frac{1}{N_{#gamma}} #frac{dN_{jet}}{dp_{T}^{jet}}", nJtPtBins, jtPtBins);
          photonGenMatchedDiJtEtaVCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtEtaVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";#eta^{jet};#frac{1}{N_{#gamma}} #frac{dN_{jet}}{d#eta^{jet}}", nEtaBins, etaBins);
          photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtMassJet1Jet2VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";m^{jet,jet} [GeV/c^{2}];#frac{1}{N_{#gamma}} #frac{dN_{jet,jet}}{dm^{jet,jet}}", nMassBins, massBins);
          photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtMassPhotonJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";m^{#gamma,jet,jet} [GeV/c^{2}];#frac{1}{N_{#gamma}} #frac{dN_{#gamma,jet,jet}}{dm^{#gamma,jet,jet}}", nMassBins, massBins);
          photonGenMatchedDiJtSumPtVCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtSumPtVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";p_{T}^{leading jet + subleading jet} [GeV/c];#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nJtPtBins, jtPtBins);
          photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtSumPtXjgVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";x_{J,#gamma} (leading jet + subleading jet);#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nXJBins, xjBins);
          photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI] = new TH2F(("photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#Delta#phi_{#gamma,subleading jet}", nDPhiBins, 0, TMath::Pi() + 0.01, nDPhiBins, 0, TMath::Pi() + 0.01);
          photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI] = new TH2F(("photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#Delta#phi_{leading jet,subleading jet}", nDPhiBins, 0, TMath::Pi() + 0.01, nDPhiBins, 0, TMath::Pi() + 0.01);
          photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";x_{J,#gamma} (J;leading jet when N_{Jet}=1 or leading jet + subleading jet);#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nXJBins, xjBins);
          //photonGenMatchedDiJtSumPtXjg_allJets_VCentPt_p[cI][pI] = new TH1F(("photonGenMatchedDiJtSumPtXjg_allJets_VCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + gammaJtDPhiStr + "_h").c_str(), ";x_{J,#gamma} (J;4 momentum sum of all jets);#frac{1}{N_{#gamma}} #frac{dN}{dp_{T}^{leading jet + subleading jet}}", nXJBins, xjBins);
          photonOnlyGenDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI] = new TH2F(("photonOnlyGenDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#Delta#phi_{#gamma,subleading jet}", nDPhiBins, 0, TMath::Pi() + 0.01, nDPhiBins, 0, TMath::Pi() + 0.01);
          photonOnlyGenDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI] = new TH2F(("photonOnlyGenDPhiJets_PhotonLeadingJetVCentPt_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_" + jtPtBinsGlobalStr + "_h").c_str(), ";#Delta#phi_{#gamma,leading jet};#Delta#phi_{leading jet,subleading jet}", nDPhiBins, 0, TMath::Pi() + 0.01, nDPhiBins, 0, TMath::Pi() + 0.01);

          centerTitles({photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonGenMatchedDiJtPtVCentPt_p[cI][pI], photonGenMatchedDiJtEtaVCentPt_p[cI][pI], photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtSumPtVCentPt_p[cI][pI], photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI], photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]});
          setSumW2({photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonGenMatchedDiJtPtVCentPt_p[cI][pI], photonGenMatchedDiJtEtaVCentPt_p[cI][pI], photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtSumPtVCentPt_p[cI][pI], photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI], photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]});

          centerTitles({photonOnlyGenDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonOnlyGenDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI]});
          setSumW2({photonOnlyGenDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonOnlyGenDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI]});

         // centerTitles({photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonGenMatchedDiJtPtVCentPt_p[cI][pI], photonGenMatchedDiJtEtaVCentPt_p[cI][pI], photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtSumPtVCentPt_p[cI][pI], photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI], photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI],photonGenMatchedDiJtSumPtXjg_allJets_VCentPt_p[cI][pI]});
         // setSumW2({photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI], photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI], photonGenMatchedDiJtPtVCentPt_p[cI][pI], photonGenMatchedDiJtEtaVCentPt_p[cI][pI], photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI], photonGenMatchedDiJtSumPtVCentPt_p[cI][pI], photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI], photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI],photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI],photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI],photonGenMatchedDiJtSumPtXjg_allJets_VCentPt_p[cI][pI]});
      }
    ...
    photonEtaPt_p[cI] = new TH2F(("photonEtaPt_" + centBinsStr[cI] + "_h").c_str(), ";#eta^{#gamma};p_{T}^{#gamma} [GeV]", nEtaBins, etaBins, nGammaPtBins, gammaPtBins);

    for(Int_t pI = 0; pI < nGammaPtBinsSub+1; ++pI){
      photonEtaPhiVCentPt_p[cI][pI] = new TH2F(("photonEtaPhi_" + centBinsStr[cI] + "_" + gammaPtBinsSubStr[pI] + "_h").c_str(), ";#eta^{#gamma};#phi^{#gamma}", nEtaBins, etaBins, nPhiBins, phiBins);
  ...
  if(doMix){
    ...
    mixTree_p->SetBranchStatus(("akt"+jetDR+"hi_em_xcalib_jet_pt").c_str(), 1);
    mixTree_p->SetBranchStatus(("akt"+jetDR+"hi_em_xcalib_jet_eta").c_str(), 1);
    mixTree_p->SetBranchStatus(("akt"+jetDR+"hi_em_xcalib_jet_phi").c_str(), 1);

    mixTree_p->SetBranchAddress("vert_z", &vert_z_p);
    mixTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_pt").c_str(), &akthi_em_xcalib_jet_pt_p);
    mixTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_eta").c_str(), &akthi_em_xcalib_jet_eta_p);
    mixTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_phi").c_str(), &akthi_em_xcalib_jet_phi_p);
	...
	TLorentzVector temp;
	temp.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jI), akthi_em_xcalib_jet_eta_p->at(jI), akthi_em_xcalib_jet_phi_p->at(jI), 0.0);
  ...
  std::vector<std::vector<Double_t> > gammaCountsPerPtCent_dijet; // events with N_jet = 2
  std::vector<std::vector<Double_t> > gammaCountsPerPtCent_dijet_truth; // events with N_jet = 2
  std::vector<std::vector<Double_t> > gammaCountsPerPtCent_singlejet; // events with N_jet = 1
  std::vector<std::vector<Double_t> > gammaCountsPerPtCent_singlejet_truth; // events with N_jet = 1
  std::vector<std::vector<Double_t> > gammaCountsPerPtCent_multijet; // events with N_jet>=3
  //std::vector<std::vector<Double_t> > gammaCountsPerPtCent_quarkjet; // 
  //std::vector<std::vector<Double_t> > gammaCountsPerPtCent_gluonjet; // 
  for(Int_t pI = 0; pI < nGammaPtBinsSub+1; ++pI){
    gammaCountsPerPtCent.push_back({});
    gammaCountsPerPtCent_dijet.push_back({});
    gammaCountsPerPtCent_dijet_truth.push_back({});
    gammaCountsPerPtCent_singlejet.push_back({});
    gammaCountsPerPtCent_singlejet_truth.push_back({});
    gammaCountsPerPtCent_multijet.push_back({});
    //gammaCountsPerPtCent_quarkjet.push_back({});
    //gammaCountsPerPtCent_gluonjet.push_back({});

    for(Int_t cI = 0; cI < nCentBins; ++cI){
      gammaCountsPerPtCent[pI].push_back(0.0);
      gammaCountsPerPtCent_dijet[pI].push_back(0.0);
      gammaCountsPerPtCent_dijet_truth[pI].push_back(0.0);
      gammaCountsPerPtCent_singlejet[pI].push_back(0.0);
      gammaCountsPerPtCent_singlejet_truth[pI].push_back(0.0);
      gammaCountsPerPtCent_multijet[pI].push_back(0.0);
      //gammaCountsPerPtCent_quarkjet[pI].push_back(0.0);
      //gammaCountsPerPtCent_gluonjet[pI].push_back(0.0);
    }
  }
  if(doGlobalDebug) std::cout << "GLOBAL DEBUG FILE, LINE: " << __FILE__ << ", " << __LINE__ << std::endl; 
  ...
  for(ULong64_t entry = 0; entry < nEntries; ++entry){
	...
	if(isMC && ((!doBackgroundPhotons && truthPhotonPt > 0) || (doBackgroundPhotons && truthPhotonPt<=0))){
        if(treePartonId[0]==22){
            treeJetIndex=1;
        } else if(treePartonId[1]==22){
            treeJetIndex=0;
        } else if(treePartonId[0]!=22 && treePartonId[1]!=22){
            //below is only valid when truthPhotonPt > 0 which is isolated prompt photons
            float dr0 = getDR(treePartonEta[0], treePartonPhi[0], truthPhotonEta, truthPhotonPhi); 
            float dr1 = getDR(treePartonEta[1], treePartonPhi[1], truthPhotonEta, truthPhotonPhi); 
            if( dr0 < dr1 ) treeJetIndex=1;
            else treeJetIndex=0;
        }
        if(abs(treePartonId[treeJetIndex])==21) gluonJetFlag = 1;
        else gluonJetFlag = 0;

        if(doGluonJet && !doQuarkJet){ 
            if(gluonJetFlag!=1) continue;
        }
        if(doQuarkJet && !doGluonJet){ 
            if(gluonJetFlag!=0) continue;
        }
    }//if MC 
    ...
    //std::cout << "yj comment: b" << std::endl;

	  if(doGlobalDebug) std::cout << "GLOBAL DEBUG FILE, LINE: " << __FILE__ << ", " << __LINE__ << std::endl; 

	if(isMC && !doBackgroundPhotons && truthPhotonPt > 0){
	    //if(isMC){
        //for(unsigned int tI = 0; tI < truth_pt_p->size(); ++tI){
        //    if(truth_pdg_p->at(tI) != 22) continue;
        //    if(truth_type_p->at(tI) != 14) continue; //Iso Photon
        ...
        //if(treePartonId->at(0)==22){
        //    treeJetIndex=1;
        //} else if(treePartonId->at(1)==22){
        //    treeJetIndex=0;
        //} else if(treePartonId->at(0)!=22 && treePartonId->at(1)!=22){
        //    //below is only valid when truthPhotonPt > 0 which is isolated prompt photons
        //    float dr0 = getDR(treePartonEta->at(0), treePartonPhi->at(0), truthPhotonEta, truthPhotonPhi); 
        //    float dr1 = getDR(treePartonEta->at(1), treePartonPhi->at(1), truthPhotonEta, truthPhotonPhi); 
        //    if( dr0 < dr1 ) treeJetIndex=1;
        //    else treeJetIndex=0;
        //}
        //if(abs(treePartonId->at(treeJetIndex))==21) gluonJetFlag = 1;
        //else gluonJetFlag = 0;
    ...
    float maxSubJpt = 0;
    float maxTruthJpt = 0;
    float maxTruthSubJpt = 0;
    unsigned int jetLeadingIndex = 999;
    unsigned int jetSubLeadingIndex = 999;
    unsigned int jetTruthLeadingIndex = 999;
    unsigned int jetTruthSubLeadingIndex = 999;


    if(akthi_em_xcalib_jet_pt_p->size() >=2){
	for(unsigned int jI = 0; jI < akthi_em_xcalib_jet_pt_p->size(); ++jI){
	  if(akthi_em_xcalib_jet_eta_p->at(jI) <= etaBinsLow) continue;
	  if(akthi_em_xcalib_jet_eta_p->at(jI) >= etaBinsHigh) continue;
	  ...
	  if(isMC){
	    int pos = akthi_truthpos_p->at(jI);
	    if(pos >= 0){
	      if(akt_truth_jet_pt_p->at(pos) >= jtPtBinsLow && akt_truth_jet_pt_p->at(pos) < jtPtBinsHigh){
		Int_t genJtPtPos = ghostPos(nJtPtBins, jtPtBins, akt_truth_jet_pt_p->at(pos), true, doGlobalDebug);		
		fillTH1(photonJtRecoOverGenVCentJtPt_p[centPos][genJtPtPos], akthi_em_xcalib_jet_pt_p->at(jI)/akt_truth_jet_pt_p->at(pos), fullWeight);
	      }
	    }
	  }
      ...
      if(akthi_em_xcalib_jet_pt_p->at(jI) < jtPtBinsLow) continue;
      if(doJetMaxPtCut){
          if(akthi_em_xcalib_jet_pt_p->at(jI) >= jtPtBinsHigh) continue;
      }

	  TLorentzVector tempJet;
	  tempJet.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jI), akthi_em_xcalib_jet_eta_p->at(jI), akthi_em_xcalib_jet_phi_p->at(jI), 0.0);
      ...
      if (akthi_em_xcalib_jet_pt_p->at(jI) > maxJpt) {
          maxJpt = akthi_em_xcalib_jet_pt_p->at(jI);
          jetLeadingIndex = jI;
      }

    // MC dijet gen matched particles 
      if(isMC){
          if(!doBackgroundPhotons && truthPhotonPt > 0){
              if(getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2){  

                  int pos = akthi_truthpos_p->at(jI);
                  if(pos >= 0){
                      if (akthi_em_xcalib_jet_pt_p->at(jI) > maxTruthJpt) {
                          maxTruthJpt = akthi_em_xcalib_jet_pt_p->at(jI);
                          jetTruthLeadingIndex = jI;
                      }
                  }
              }
          } else if(doBackgroundPhotons && truthPhotonPt <= 0){
              int pos = akthi_truthpos_p->at(jI);
              if(pos >= 0){
                  if (akthi_em_xcalib_jet_pt_p->at(jI) > maxTruthJpt) {
                      maxTruthJpt = akthi_em_xcalib_jet_pt_p->at(jI);
     ...
     // end dijet 
	  if(dPhi >= gammaJtDPhiCut){
	    ...
	    fillTH1(photonJtPtVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jI), fullWeight);
	    fillTH1(photonJtPtVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jI), fullWeight);
	    fillTH1(photonJtEtaVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_eta_p->at(jI), fullWeight);
	    fillTH1(photonJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_eta_p->at(jI), fullWeight);
	    fillTH1(photonJtXJVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jI)/photon_pt_p->at(pI), fullWeight);
	    fillTH1(photonJtXJVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jI)/photon_pt_p->at(pI), fullWeight);

	    ++multCounter;
	    
	    if(isMC){
	      if(akthi_truthpos_p->at(jI) < 0){
		fillTH1(photonJtFakeVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jI), fullWeight);
	      }
	      else{
 		fillTH1(photonGenMatchedJtPtVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jI), fullWeight);
		fillTH1(photonGenMatchedJtPtVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jI), fullWeight);
		fillTH1(photonGenMatchedJtEtaVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_eta_p->at(jI), fullWeight);
		fillTH1(photonGenMatchedJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_eta_p->at(jI), fullWeight);
		fillTH1(photonGenMatchedJtXJVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jI)/photon_pt_p->at(pI), fullWeight);
		fillTH1(photonGenMatchedJtXJVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jI)/photon_pt_p->at(pI), fullWeight);
		...
		if(!doBackgroundPhotons && truthPhotonPt > 0){
		  ...
		  if(getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2){
		    if(truthPhotonPt >= gammaPtBins[0] && truthPhotonPt < gammaPtBins[nGammaPtBins]){
		      ...
		      fillTH2(photonJtGenResVCentGenPtRecoPt_p[centPos][genPtPos][recoPtPos], akthi_em_xcalib_jet_pt_p->at(jI), akt_truth_jet_pt_p->at(akthi_truthpos_p->at(jI)), fullWeight); 
		    }
		  }
		} 
        //else if(doBackgroundPhotons && truthPhotonPt<= 0){
    ...
    //searching for the subleading jet
    if(akthi_em_xcalib_jet_pt_p->size() >=2){
	for(unsigned int jI = 0; jI < akthi_em_xcalib_jet_pt_p->size(); ++jI){
	  if(akthi_em_xcalib_jet_eta_p->at(jI) <= etaBinsLow) continue;
	  if(akthi_em_xcalib_jet_eta_p->at(jI) >= etaBinsHigh) continue;
      ...
      if (jI==jetLeadingIndex) continue; 
	 
      if (akthi_em_xcalib_jet_pt_p->at(jI) > maxSubJpt) {
          maxSubJpt = akthi_em_xcalib_jet_pt_p->at(jI);
          jetSubLeadingIndex = jI;
      }
      ...
      //        if (jI==jetTruthLeadingIndex) continue; 
      //        int pos = akthi_truthpos_p->at(jI);
      //        if(pos >= 0){
      //            if (akthi_em_xcalib_jet_pt_p->at(jI) > maxTruthSubJpt) {
      //                maxTruthSubJpt = akthi_em_xcalib_jet_pt_p->at(jI);
      //                jetTruthSubLeadingIndex = jI;
      //            }
      //        }
      //    }
      //}
    ...
    //std::cout << "subleadingindex = " << jetSubLeadingIndex << ", leadingindex = " << jetLeadingIndex << std::endl;
    //std::cout << "maxSubJpt= " << maxSubJpt << ", sanity check = " << akthi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex) << std::endl;
    //std::cout << "maxJpt= " << maxJpt << ", sanity check = " << akthi_em_xcalib_jet_pt_p->at(jetLeadingIndex) << std::endl;

    // events with multi jet (N_jet = 1) 
    if(jetSubLeadingIndex!=999 && jetLeadingIndex!=999){ 

        if(!isMC){
            ++(gammaCountsPerPtCent_dijet[ptPos][centPos]);
            ++(gammaCountsPerPtCent_dijet[nGammaPtBinsSub][centPos]);
        } else{
            gammaCountsPerPtCent_dijet[ptPos][centPos] += fullWeight;
            gammaCountsPerPtCent_dijet[nGammaPtBinsSub][centPos] += fullWeight;
        }

        Float_t dPhi_jetjet = TMath::Abs(getDPHI(akthi_em_xcalib_jet_phi_p->at(jetSubLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetLeadingIndex)));
        fillTH1(photonDiJtDPhiJet1Jet2VCentPt_p[centPos][ptPos], dPhi_jetjet, fullWeight);
        fillTH1(photonDiJtDPhiJet1Jet2VCentPt_p[centPos][nGammaPtBinsSub], dPhi_jetjet, fullWeight);

        Float_t dPhi_jet1photon = TMath::Abs(getDPHI(akthi_em_xcalib_jet_phi_p->at(jetLeadingIndex), photon_phi_p->at(pI)));
        fillTH1(photonDiJtDPhiPhotonJet1VCentPt_p[centPos][ptPos], dPhi_jet1photon, fullWeight);
        fillTH1(photonDiJtDPhiPhotonJet1VCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon, fullWeight);

        Float_t dPhi_jet2photon = TMath::Abs(getDPHI(akthi_em_xcalib_jet_phi_p->at(jetSubLeadingIndex), photon_phi_p->at(pI)));
        fillTH1(photonDiJtDPhiPhotonJet2VCentPt_p[centPos][ptPos], dPhi_jet2photon, fullWeight);
        fillTH1(photonDiJtDPhiPhotonJetsVCentPt_p[centPos][ptPos], dPhi_jet1photon, fullWeight);
        fillTH1(photonDiJtDPhiPhotonJetsVCentPt_p[centPos][ptPos], dPhi_jet2photon, fullWeight);
        fillTH1(photonDiJtDPhiPhotonJet2VCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet2photon, fullWeight);
        fillTH1(photonDiJtDPhiPhotonJetsVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon, fullWeight);
        fillTH1(photonDiJtDPhiPhotonJetsVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet2photon, fullWeight);

        fillTH1(photonDiJtPtVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jetLeadingIndex), fullWeight);
        fillTH1(photonDiJtPtVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex), fullWeight);
        fillTH1(photonDiJtEtaVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_eta_p->at(jetLeadingIndex), fullWeight);
        fillTH1(photonDiJtEtaVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_eta_p->at(jetSubLeadingIndex), fullWeight);
        fillTH1(photonDiJtPtVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jetLeadingIndex), fullWeight);
        fillTH1(photonDiJtPtVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex), fullWeight);
        fillTH1(photonDiJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_eta_p->at(jetLeadingIndex), fullWeight);
        fillTH1(photonDiJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_eta_p->at(jetSubLeadingIndex), fullWeight);

        //fill dijet mass plots
        TLorentzVector tempPhoton, tempJet1, tempJet2;
        tempPhoton.SetPtEtaPhiM(photon_pt_p->at(pI), photon_eta_p->at(pI), photon_phi_p->at(pI), 0.0);
        tempJet1.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jetLeadingIndex), akthi_em_xcalib_jet_eta_p->at(jetLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetLeadingIndex), 0.0);
        tempJet2.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex), akthi_em_xcalib_jet_eta_p->at(jetSubLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetSubLeadingIndex), 0.0);
        fillTH1(photonDiJtMassJet1Jet2VCentPt_p[centPos][ptPos], (tempJet1+tempJet2).M(), fullWeight);
        fillTH1(photonDiJtMassPhotonJet1Jet2VCentPt_p[centPos][ptPos], (tempPhoton+tempJet1+tempJet2).M(), fullWeight);
        fillTH1(photonDiJtMassJet1Jet2VCentPt_p[centPos][nGammaPtBinsSub], (tempJet1+tempJet2).M(), fullWeight);
        fillTH1(photonDiJtMassPhotonJet1Jet2VCentPt_p[centPos][nGammaPtBinsSub], (tempPhoton+tempJet1+tempJet2).M(), fullWeight);
        fillTH1(photonDiJtSumPtVCentPt_p[centPos][ptPos], (tempJet1+tempJet2).Pt(), fullWeight);
        fillTH1(photonDiJtSumPtXjgVCentPt_p[centPos][ptPos], (tempJet1+tempJet2).Pt()/photon_pt_p->at(pI), fullWeight);
        fillTH1(photonDiJtSumPtVCentPt_p[centPos][nGammaPtBinsSub], (tempJet1+tempJet2).Pt(), fullWeight);
        fillTH1(photonDiJtSumPtXjgVCentPt_p[centPos][nGammaPtBinsSub], (tempJet1+tempJet2).Pt()/photon_pt_p->at(pI), fullWeight);
        //fill dijet 2D plots 
        fillTH2(photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[centPos][ptPos], dPhi_jet1photon, dPhi_jet2photon, fullWeight);
        fillTH2(photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon, dPhi_jet2photon, fullWeight);
        fillTH2(photonDPhiJets_PhotonLeadingJetVCentPt_p[centPos][ptPos], dPhi_jet1photon, dPhi_jetjet, fullWeight);
        fillTH2(photonDPhiJets_PhotonLeadingJetVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon, dPhi_jetjet, fullWeight);
        fillTH1(photonDiJtSumPtXjg_includingN1_VCentPt_p[centPos][ptPos], tempJet1.Pt()/photon_pt_p->at(pI), fullWeight);
        fillTH1(photonDiJtSumPtXjg_includingN1_VCentPt_p[centPos][nGammaPtBinsSub], tempJet1.Pt()/photon_pt_p->at(pI), fullWeight);
    }

    // events with single jet (N_jet = 1) + dijet 
    if(jetSubLeadingIndex==999 && jetLeadingIndex!=999){ 
        if(!isMC){
            ++(gammaCountsPerPtCent_singlejet[ptPos][centPos]);
            ++(gammaCountsPerPtCent_singlejet[nGammaPtBinsSub][centPos]);
        } else{
            gammaCountsPerPtCent_singlejet[ptPos][centPos] += fullWeight;
            gammaCountsPerPtCent_singlejet[nGammaPtBinsSub][centPos] += fullWeight;
        }
    ...
    //searching for the subleading jet
    if(isMC){
        if((!doBackgroundPhotons && truthPhotonPt > 0) || (doBackgroundPhotons && truthPhotonPt <= 0)){
            if(!doBackgroundPhotons && (getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2)) continue;  
            if(akthi_em_xcalib_jet_pt_p->size() >=2){
                for(unsigned int jI = 0; jI < akthi_em_xcalib_jet_pt_p->size(); ++jI){
                    if(akthi_em_xcalib_jet_eta_p->at(jI) <= etaBinsLow) continue;
                    if(akthi_em_xcalib_jet_eta_p->at(jI) >= etaBinsHigh) continue;
    ...
    if(isMC && ((!doBackgroundPhotons && truthPhotonPt > 0 && (getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2)) || (doBackgroundPhotons && truthPhotonPt<=0))){  
        if(jetTruthSubLeadingIndex!=999 && jetTruthLeadingIndex!=999){

            gammaCountsPerPtCent_dijet_truth[ptPos][centPos] += fullWeight;
            gammaCountsPerPtCent_dijet_truth[nGammaPtBinsSub][centPos] += fullWeight;

            Float_t dPhi_jetjet_truth = TMath::Abs(getDPHI(akthi_em_xcalib_jet_phi_p->at(jetTruthSubLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetTruthLeadingIndex)));
            fillTH1(photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[centPos][ptPos], dPhi_jetjet_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[centPos][nGammaPtBinsSub], dPhi_jetjet_truth, fullWeight);

            Float_t dPhi_jet1photon_truth = TMath::Abs(getDPHI(akthi_em_xcalib_jet_phi_p->at(jetTruthLeadingIndex), photon_phi_p->at(pI)));
            fillTH1(photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[centPos][ptPos], dPhi_jet1photon_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon_truth, fullWeight);

            Float_t dPhi_jet2photon_truth = TMath::Abs(getDPHI(akthi_em_xcalib_jet_phi_p->at(jetTruthSubLeadingIndex), photon_phi_p->at(pI)));
            fillTH1(photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[centPos][ptPos], dPhi_jet2photon_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[centPos][ptPos], dPhi_jet1photon_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[centPos][ptPos], dPhi_jet2photon_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet2photon_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon_truth, fullWeight);
            fillTH1(photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet2photon_truth, fullWeight);

            fillTH1(photonGenMatchedDiJtPtVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jetTruthLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtPtVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_pt_p->at(jetTruthSubLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtEtaVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_eta_p->at(jetTruthLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtEtaVCentPt_p[centPos][ptPos], akthi_em_xcalib_jet_eta_p->at(jetTruthSubLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtPtVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jetTruthLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtPtVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_pt_p->at(jetTruthSubLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_eta_p->at(jetTruthLeadingIndex), fullWeight);
            fillTH1(photonGenMatchedDiJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akthi_em_xcalib_jet_eta_p->at(jetTruthSubLeadingIndex), fullWeight);

            //fill dijet mass plots
            TLorentzVector tempPhoton_truth, tempJet1_truth, tempJet2_truth;
            tempPhoton_truth.SetPtEtaPhiM(photon_pt_p->at(pI), photon_eta_p->at(pI), photon_phi_p->at(pI), 0.0);
            tempJet1_truth.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jetTruthLeadingIndex), akthi_em_xcalib_jet_eta_p->at(jetTruthLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetTruthLeadingIndex), 0.0);
            tempJet2_truth.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jetTruthSubLeadingIndex), akthi_em_xcalib_jet_eta_p->at(jetTruthSubLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetTruthSubLeadingIndex), 0.0);
            fillTH1(photonGenMatchedDiJtMassJet1Jet2VCentPt_p[centPos][ptPos], (tempJet1_truth+tempJet2_truth).M(), fullWeight);
            fillTH1(photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[centPos][ptPos], (tempPhoton_truth+tempJet1_truth+tempJet2_truth).M(), fullWeight);
            fillTH1(photonGenMatchedDiJtMassJet1Jet2VCentPt_p[centPos][nGammaPtBinsSub], (tempJet1_truth+tempJet2_truth).M(), fullWeight);
            fillTH1(photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[centPos][nGammaPtBinsSub], (tempPhoton_truth+tempJet1_truth+tempJet2_truth).M(), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtVCentPt_p[centPos][ptPos], (tempJet1_truth+tempJet2_truth).Pt(), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtXjgVCentPt_p[centPos][ptPos], (tempJet1_truth+tempJet2_truth).Pt()/photon_pt_p->at(pI), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtVCentPt_p[centPos][nGammaPtBinsSub], (tempJet1_truth+tempJet2_truth).Pt(), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtXjgVCentPt_p[centPos][nGammaPtBinsSub], (tempJet1_truth+tempJet2_truth).Pt()/photon_pt_p->at(pI), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[centPos][ptPos], tempJet1_truth.Pt()/photon_pt_p->at(pI), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[centPos][nGammaPtBinsSub], tempJet1_truth.Pt()/photon_pt_p->at(pI), fullWeight);
            //fill dijet 2D plots 
            fillTH2(photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[centPos][ptPos], dPhi_jet1photon_truth, dPhi_jet2photon_truth, fullWeight);
            fillTH2(photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon_truth, dPhi_jet2photon_truth, fullWeight);
            fillTH2(photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[centPos][ptPos], dPhi_jet1photon_truth, dPhi_jetjet_truth, fullWeight);
            fillTH2(photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[centPos][nGammaPtBinsSub], dPhi_jet1photon_truth, dPhi_jetjet_truth, fullWeight);
        }
    }
    // end dijet GenMatched


    if(isMC && ((!doBackgroundPhotons && truthPhotonPt > 0 && (getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2)) || (doBackgroundPhotons && truthPhotonPt<=0))){  
    //if((isMC && truthPhotonPt > 0) && (getDR(photon_eta_p->at(pI), photon_phi_p->at(pI), truthPhotonEta, truthPhotonPhi) < 0.2)){  
        if(jetTruthSubLeadingIndex==999 && jetTruthLeadingIndex!=999){

            gammaCountsPerPtCent_singlejet_truth[ptPos][centPos] += fullWeight;
            gammaCountsPerPtCent_singlejet_truth[nGammaPtBinsSub][centPos] += fullWeight;

            //fill dijet mass plots
            TLorentzVector tempJet1_truth;
            tempJet1_truth.SetPtEtaPhiM(akthi_em_xcalib_jet_pt_p->at(jetTruthLeadingIndex), akthi_em_xcalib_jet_eta_p->at(jetTruthLeadingIndex), akthi_em_xcalib_jet_phi_p->at(jetTruthLeadingIndex), 0.0);
            fillTH1(photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[centPos][ptPos], tempJet1_truth.Pt()/photon_pt_p->at(pI), fullWeight);
            fillTH1(photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[centPos][nGammaPtBinsSub], tempJet1_truth.Pt()/photon_pt_p->at(pI), fullWeight);
        }
	...
	if(isMC){
	  for(unsigned int tI = 0; tI < akt_truth_jet_pt_p->size(); ++tI){
	    if(akt_truth_jet_pt_p->at(tI) < jtPtBinsLow) continue;
	    if(akt_truth_jet_eta_p->at(tI) <= etaBinsLow) continue;
	    if(akt_truth_jet_eta_p->at(tI) >= etaBinsHigh) continue;
	  
	    Float_t dR = getDR(akt_truth_jet_eta_p->at(tI), akt_truth_jet_phi_p->at(tI), photon_eta_p->at(pI), photon_phi_p->at(pI));
	    if(dR < 0.3) continue;
	  
	    Float_t dPhi = TMath::Abs(getDPHI(akt_truth_jet_phi_p->at(tI), photon_phi_p->at(pI)));
	    ...
	    if(dPhi >= gammaJtDPhiCut){
	      fillTH1(photonGenJtPtVCentPt_p[centPos][ptPos], akt_truth_jet_pt_p->at(tI), fullWeight);
	      fillTH1(photonGenJtPtVCentPt_p[centPos][nGammaPtBinsSub], akt_truth_jet_pt_p->at(tI), fullWeight);
	      fillTH1(photonGenJtEtaVCentPt_p[centPos][ptPos], akt_truth_jet_eta_p->at(tI), fullWeight);
	      fillTH1(photonGenJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akt_truth_jet_eta_p->at(tI), fullWeight);
	      fillTH1(photonGenJtXJVCentPt_p[centPos][ptPos], akt_truth_jet_pt_p->at(tI)/photon_pt_p->at(pI), fullWeight);
	      fillTH1(photonGenJtXJVCentPt_p[centPos][nGammaPtBinsSub], akt_truth_jet_pt_p->at(tI)/photon_pt_p->at(pI), fullWeight);
	      ++multCounterGen;
	    }
	  }
	}
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    std::cout << "gammaCountsPerPtCent_dijet (cent" << cI << ", photonPt" << pI << ") : " << gammaCountsPerPtCent_dijet[pI][cI] << std::endl;
    if(isMC) std::cout << "gammaCountsPerPtCent_dijet_truth (cent" << cI << ", photonPt" << pI << ") : " << gammaCountsPerPtCent_dijet_truth[pI][cI] << std::endl;
    std::cout << "gammaCountsPerPtCent (cent" << cI << ", photonPt" << pI << ") : " << gammaCountsPerPtCent[pI][cI] << std::endl;
    std::cout << "gammaCountsPerPtCent_singlejet (cent" << cI << ", photonPt" << pI << ") : " << gammaCountsPerPtCent_singlejet[pI][cI] << std::endl;
    std::cout << "gammaCountsPerPtCent_multijet (cent" << cI << ", photonPt" << pI << ") : " << gammaCountsPerPtCent_multijet[pI][cI] << std::endl;


    //dijets 
  photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtPtVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtEtaVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtMassJet1Jet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtSumPtVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtSumPtXjgVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]->Scale(1./(gammaCountsPerPtCent_dijet[pI][cI]+gammaCountsPerPtCent_singlejet[pI][cI]));
  photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
  photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet[pI][cI]);
    //dijets MC
    if(isMC){ 
  photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtPtVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtEtaVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtSumPtVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]->Scale(1./(gammaCountsPerPtCent_dijet_truth[pI][cI]+gammaCountsPerPtCent_singlejet_truth[pI][cI]));
  photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
  photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI]->Scale(1./gammaCountsPerPtCent_dijet_truth[pI][cI]);
    }
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    //  photonJtMultVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      ...
      //dijets
      photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtPtVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtEtaVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtMassJet1Jet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonDiJtSumPtVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonDiJtSumPtXjgVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);

      //dijet MC
      if(isMC){
      photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtPtVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtEtaVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);;
      photonGenMatchedDiJtSumPtVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI]->Write("", TObject::kOverwrite);
      }
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    for(Int_t pI = 0; pI < nGammaPtBinsSub+1; ++pI){
      ...
      //dijet
      delete photonDiJtDPhiJet1Jet2VCentPt_p[cI][pI];
      delete photonDiJtDPhiPhotonJetsVCentPt_p[cI][pI];
      delete photonDiJtDPhiPhotonJet1VCentPt_p[cI][pI];
      delete photonDiJtDPhiPhotonJet2VCentPt_p[cI][pI];
      delete photonDiJtPtVCentPt_p[cI][pI];
      delete photonDiJtEtaVCentPt_p[cI][pI];
      delete photonDiJtMassJet1Jet2VCentPt_p[cI][pI];
      delete photonDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI];
      delete photonDiJtSumPtVCentPt_p[cI][pI];
      delete photonDiJtSumPtXjgVCentPt_p[cI][pI];
      delete photonDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI];
      delete photonDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI];
      delete photonDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI];
      //dijet M MCC
      if(isMC){
      delete photonGenMatchedDiJtDPhiJet1Jet2VCentPt_p[cI][pI];
      delete photonGenMatchedDiJtDPhiPhotonJetsVCentPt_p[cI][pI];
      delete photonGenMatchedDiJtDPhiPhotonJet1VCentPt_p[cI][pI];
      delete photonGenMatchedDiJtDPhiPhotonJet2VCentPt_p[cI][pI];
      delete photonGenMatchedDiJtPtVCentPt_p[cI][pI];
      delete photonGenMatchedDiJtEtaVCentPt_p[cI][pI];
      delete photonGenMatchedDiJtMassJet1Jet2VCentPt_p[cI][pI];
      delete photonGenMatchedDiJtMassPhotonJet1Jet2VCentPt_p[cI][pI];
      delete photonGenMatchedDiJtSumPtVCentPt_p[cI][pI];
      delete photonGenMatchedDiJtSumPtXjgVCentPt_p[cI][pI];
      delete photonGenMatchedDiJtSumPtXjg_includingN1_VCentPt_p[cI][pI];
      delete photonGenMatchedDPhiPhotonLeadingJet_PhotonSubleadingJetVCentPt_p[cI][pI];
      delete photonGenMatchedDPhiJets_PhotonLeadingJetVCentPt_p[cI][pI];
      }
...
{
  if(argc != 2){
    std::cout << "Usage: ./bin/gdjNTupleToHist_dijet.exe <inConfigFileName>" << std::endl;
  ...
  int retVal = 0;
  retVal += gdjNTupleToHist_dijet(argv[1]);
  return retVal;
}
