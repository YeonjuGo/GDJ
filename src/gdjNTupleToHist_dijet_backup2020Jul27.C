...
int gdjNTupleToHist_dijet(std::string inConfigFileName)
{
 ...
 //Pt sub bins handling
  ...
  if(doMix){
    ...
    mixTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_pt").c_str(), &akt4hi_em_xcalib_jet_pt_p);
    mixTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_eta").c_str(), &akt4hi_em_xcalib_jet_eta_p);
    mixTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_phi").c_str(), &akt4hi_em_xcalib_jet_phi_p);
  ...
  inTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_pt").c_str(), &akt4hi_em_xcalib_jet_pt_p);
  inTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_eta").c_str(), &akt4hi_em_xcalib_jet_eta_p);
  inTree_p->SetBranchAddress(("akt"+jetDR+"hi_em_xcalib_jet_phi").c_str(), &akt4hi_em_xcalib_jet_phi_p);

  if(isMC){
    inTree_p->SetBranchAddress(("akt"+jetDR+"hi_truthpos").c_str(), &akt4hi_truthpos_p);    

    inTree_p->SetBranchAddress(("akt"+jetDR+"_truth_jet_pt").c_str(), &akt4_truth_jet_pt_p);
    inTree_p->SetBranchAddress(("akt"+jetDR+"_truth_jet_eta").c_str(), &akt4_truth_jet_eta_p);
    inTree_p->SetBranchAddress(("akt"+jetDR+"_truth_jet_phi").c_str(), &akt4_truth_jet_phi_p);
  }
  ...
  for(ULong64_t entry = 0; entry < nEntries; ++entry){
    ...
    if(akt4hi_em_xcalib_jet_pt_p->size() >=2){
	for(unsigned int jI = 0; jI < akt4hi_em_xcalib_jet_pt_p->size(); ++jI){
	  if(akt4hi_em_xcalib_jet_eta_p->at(jI) <= etaBinsLow) continue;
	  if(akt4hi_em_xcalib_jet_eta_p->at(jI) >= etaBinsHigh) continue;
    ...
    //std::cout << "yj comment: f" << std::endl;
      ...
      if (akt4hi_em_xcalib_jet_pt_p->at(jI) > maxJpt) {
          maxJpt = akt4hi_em_xcalib_jet_pt_p->at(jI);
          jetLeadingIndex = jI;
      }
	...
	for(unsigned int jI = 0; jI < akt4hi_em_xcalib_jet_pt_p->size(); ++jI){
      ...
      if (akt4hi_em_xcalib_jet_pt_p->at(jI) > maxSubJpt) {
          maxSubJpt = akt4hi_em_xcalib_jet_pt_p->at(jI);
    ...
    //std::cout << "maxSubJpt= " << maxSubJpt << ", sanity check = " << akt4hi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex) << std::endl;
    //std::cout << "maxJpt= " << maxJpt << ", sanity check = " << akt4hi_em_xcalib_jet_pt_p->at(jetLeadingIndex) << std::endl;

	Float_t dPhi_jetjet = TMath::Abs(getDPHI(akt4hi_em_xcalib_jet_phi_p->at(jetSubLeadingIndex), akt4hi_em_xcalib_jet_phi_p->at(jetLeadingIndex)));
	...
	Float_t dPhi_jet1photon = TMath::Abs(getDPHI(akt4hi_em_xcalib_jet_phi_p->at(jetLeadingIndex), photon_phi_p->at(pI)));
	...
	Float_t dPhi_jet2photon = TMath::Abs(getDPHI(akt4hi_em_xcalib_jet_phi_p->at(jetSubLeadingIndex), photon_phi_p->at(pI)));
    ...
    fillTH1(photonDiJtPtVCentPt_p[centPos][ptPos], akt4hi_em_xcalib_jet_pt_p->at(jetLeadingIndex), fullWeight);
    fillTH1(photonDiJtPtVCentPt_p[centPos][ptPos], akt4hi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex), fullWeight);
    fillTH1(photonDiJtEtaVCentPt_p[centPos][ptPos], akt4hi_em_xcalib_jet_eta_p->at(jetLeadingIndex), fullWeight);
    fillTH1(photonDiJtEtaVCentPt_p[centPos][ptPos], akt4hi_em_xcalib_jet_eta_p->at(jetSubLeadingIndex), fullWeight);
    fillTH1(photonDiJtPtVCentPt_p[centPos][nGammaPtBinsSub], akt4hi_em_xcalib_jet_pt_p->at(jetLeadingIndex), fullWeight);
    fillTH1(photonDiJtPtVCentPt_p[centPos][nGammaPtBinsSub], akt4hi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex), fullWeight);
    fillTH1(photonDiJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akt4hi_em_xcalib_jet_eta_p->at(jetLeadingIndex), fullWeight);
    fillTH1(photonDiJtEtaVCentPt_p[centPos][nGammaPtBinsSub], akt4hi_em_xcalib_jet_eta_p->at(jetSubLeadingIndex), fullWeight);
	...
	tempJet1.SetPtEtaPhiM(akt4hi_em_xcalib_jet_pt_p->at(jetLeadingIndex), akt4hi_em_xcalib_jet_eta_p->at(jetLeadingIndex), akt4hi_em_xcalib_jet_phi_p->at(jetLeadingIndex), 0.0);
	tempJet2.SetPtEtaPhiM(akt4hi_em_xcalib_jet_pt_p->at(jetSubLeadingIndex), akt4hi_em_xcalib_jet_eta_p->at(jetSubLeadingIndex), akt4hi_em_xcalib_jet_phi_p->at(jetSubLeadingIndex), 0.0);
